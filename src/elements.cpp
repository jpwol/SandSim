        ...
        if(matrix_y + 1 < matrix.worldHeight){
            ...
            if(matrix.getTypeAtCell(matrix_x, matrix_y + 1) == EMPTY){
                ...
                if(lastEmpty != matrix_y){
                    matrix.moveTo(matrix.getElementAtCell(matrix_x, matrix_y), matrix_x, lastEmpty);
                }
            }
            else if(vel.first != 0 && matrix_x - 1 > 0 && matrix_x + 1 < matrix.worldWidth){
                lastEmpty = matrix_x;
                if(vel.first < 0){
                ...
                if(lastEmpty != matrix_x)
                    matrix.moveTo(matrix.getElementAtCell(matrix_x, matrix_y), lastEmpty, matrix_y);
            }
